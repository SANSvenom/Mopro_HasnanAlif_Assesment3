...
import com.hasnan0062.assesment3.network.ImgbbApi
import com.hasnan0062.assesment3.network.ResepApi
...
class MainViewModel : ViewModel() {
    ...
    fun uploadAndSave(
        ...
        viewModelScope.launch {
            ...
            if (imageUrl != null) {
                saveData(nama, waktu, keterangan, userId, imageUrl)
                onSuccess()
            } else {
    ...
    fun updateData(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ResepApi.service.updateResep(id, nama, waktu, keterangan, userId, imageUrl)
                retrieveData(userId)
            } catch (e: Exception) {
